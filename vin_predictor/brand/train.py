...
class VINBrandPredictor:
    ...
    def load_and_preprocess_data(self, csv_file_path):
        ...
        df['brand'] = df['brand'].str.strip().replace("-", " ")  # Remove whitespace from brand names
        df['brand'] = df['brand'].str.lower()  # to lowercase
...
if __name__ == "__main__":
    ...
    model, history = predictor.train_model('data/brand/vin_brand_100k.csv', epochs=30)
    ...
    # Save the model
    predictor.save_model("models/brand/vin_brand_predictor")